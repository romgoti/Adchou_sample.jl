...
Adchou_sample.figure7() # all-included function
savefig("figures/Figure_7")
...
begin
    plot(range(0,4,Int(T/2)),m1[:V][1:Int(T/2),1],line=(2,:blue), label = "V1(a)",yticks =nothing)
    plot!(range(0,4,Int(T/2)),m1[:V][1:Int(T/2),2],line=(2,:red), label = "V2(a)")
    plot!(range(0,4,Int(T/2)),m2[:V][1:Int(T/2),1],line=(2,:blue,:dash), label = "V1(a)")
    plot!(range(0,4,Int(T/2)),m2[:V][1:Int(T/2),2],line=(2,:red,:dash), label = "V2(a)")
end

begin
    plot(range(0,4,Int(T/2)),m1[:sf][1:Int(T/2),1],line=(2,:blue), label = "V1(a)")
    plot!(range(0,4,Int(T/2)),m1[:sf][1:Int(T/2),2],line=(2,:red), label = "V2(a)")
    plot!(range(0,4,Int(T/2)),m2[:sf][1:Int(T/2),1],line=(2,:blue,:dash), label = "V1(a)")
    plot!(range(0,4,Int(T/2)),m2[:sf][1:Int(T/2),2],line=(2,:red,:dash), label = "V2(a)")
end    

begin
    plot(range(0,4,Int(T/2)),m1[:g][1:Int(T/2),1],line=(2,:blue), label = "g1(a)")
    plot!(range(0,4,Int(T/2)),m1[:g][1:Int(T/2),2],line=(2,:red), label = "g2(a)")
    vline!([m1[:K]],line=(2,:lightgrey), label = "K*" )
    vline!([m2[:K]],line=(2,:lightgrey,:dash), label = "K*" )
    plot!(range(0,4,Int(T/2)),m2[:g][1:Int(T/2),1],line=(2,:blue,:dash), label = "g1(a)")
    plot!(range(0,4,Int(T/2)),m2[:g][1:Int(T/2),2],line=(2,:red,:dash), label = "g2(a)")
end
...
Adchou_sample.figure10() # all-included function
savefig("figures/Figure_10")
